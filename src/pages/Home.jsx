    ...
    <div className="home">
          ...
          <div className="category-grid">
            {CATEGORIES.map((cat, i) => (
              <Link key={cat.slug} to={`/products?category=${cat.slug}`} className="category-tile">
                <img src={`https://picsum.photos/seed/kalamandir-cat-${i}/600/750`} alt="" />
                <span>{cat.name}</span>
              </Link>
            ))}
          </div>
      ...
      <section className="best-seller-video">
        <div className="container video-grid">
          ...
          <video
            ...
            aria-label="A short video of best-selling Kalamandir pieces"
          />
        </div>
      </section>
      ...
      <section className="our-store">
        <div className="container store-grid">
          <img src="https://picsum.photos/seed/kalamandir-store/900/650" alt="Kalamandir flagship store interior" />
